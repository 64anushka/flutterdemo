...
import 'package:project/api/api_searchbyid.dart';
                      ...
                      children: <Widget>[
                        ...
                        FlatButton(
                          ...
                          onPressed: () {
                            ...
                            apiService
                                .searchbyIdRequest(searchController.text)
                                .then((List<PlantModel> PlantList) {
                              print("Login API service");
                              // print(PlantList[0].uid);
                              // print(PlantList[0].local_name);
                              // print(PlantList[0].scientific_name);
